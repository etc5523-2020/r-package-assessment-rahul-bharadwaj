#' Daily Covid-19 Data for South Africa
#' 
#' This data contains 271 observations and 6 variables for Covid stats in South Africa from January 2020. The data is wrangled from the following original data source.
#' 
#' @source
